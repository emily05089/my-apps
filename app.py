...
<body>
    <h1>双识别工具</h1>
    <div>
        <button class="btn" onclick="document.getElementById('fileInput').click()">添加图片/PDF</button>
    ...
    <div id="loading" style="display:none;color:red;">正在识别，请稍候...</div>
    
    <form id="uploadForm" method="post" enctype="multipart/form-data">
        <textarea id="result" name="result" placeholder="识别结果将在此显示">{{ result }}</textarea>
